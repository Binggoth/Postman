...
public class RegistrationInfor {
    ...
    private CertificateType certufucate_type;
    
    
    
    public CertificateType getCertufucate_type() {
		return certufucate_type;
	}

	public void setCertufucate_type(CertificateType certufucate_type) {
		this.certufucate_type = certufucate_type;
	}
